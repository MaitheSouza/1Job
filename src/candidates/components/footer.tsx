...
export const Footer = () => {
	return (
		<Flex px={10} gap={8} justifyContent="space-between">
			<Box px={10} w="full">
				<Heading ml={7} color="white" fontSize={32} letterSpacing="3px" pt={8}>
					<Link px={10} alignItems="center">
						<svg
							width="70"
							height="50"
							viewBox="0 0 80 56"
				...
				<HStack gap={10} mx={7} justify="flex-start">
					<VStack
					...
					<VStack
						...
						py={5}
					>
						<Heading alignSelf="flex-start" fontSize="20" pb={2}>
							Redes Sociais
						</Heading>
						<Text>
							Nos siga nas redes sociais para ficar sabendo em primeira mão as
							últimas vagas postadas.
						</Text>
						<Icon>Instagram</Icon>
						<Icon>LinkedIn</Icon>
					</VStack>
				...
				<Box mx={7} py={8} pb={12} gap={8} justifyContent="space-between">
					<Divider />
					<Text fontSize={14} pt={8} color="white" letterSpacing={2}>
						Copyright © 2022 1Job. Todos os direitos reservados.
						<Text fontSize={14} color="white" letterSpacing={2} float="right">
							Português
						</Text>
					</Text>
				</Box>
